        ...
        <div className="flex-1 lg:border-r border-b flex flex-col items-center border-indigo-100 space-y-8 py-10 ">
          ...
          <div>
            ...
            <div className="flex items-center space-x-4 pt-4">
              ...
              <img
                alt="c++"
                src="https://adaptabiz.com/wp-content/uploads/2020/09/1200px-ISO_C_Logo.svg-267x300.png"
                className="h-18 w-12"
              />
            </div>
          </div>
          <div>
            ...
            <div className="flex  items-center space-x-4 pt-4">
              <a href="https://www.codechef.com/users/dibyam_jalan">
                <img
              ...
              <a href="https://leetcode.com/dibyam1jalan/">
                <img
              ...
              <a href="https://codeforces.com/profile/dibyam_jalan">
                <img
